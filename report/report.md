- [INTRODUCTION](#introduction)
  ...
  - [Tumor Subtype Identification](#tumor-subtype-identification)
  - [The Cancer Genome Atlas (TCGA) Project](#the-cancer-genome-atlas-tcga-project)
  - [Objectives](#objectives)
- [METHODS](#methods)
  - [Data](#data)
    - [Source Comparison](#source-comparison)
    - [Tumor Subtypes](#tumor-subtypes)
    - [iCluster](#icluster)
  - [Preprocessing](#preprocessing)
    - [miRNA, mRNA and Proteins pipelines](#mirna-mrna-and-proteins-pipelines)
      - [Missing values handling](#missing-values-handling)
      - [Main Tumor Selection](#main-tumor-selection)
      - [Dimensionality Reduction](#dimensionality-reduction)
      - [Barcode Truncation](#barcode-truncation)
    - [Phenotype Data Pipeline](#phenotype-data-pipeline)
    - [Common Pipeline](#common-pipeline)
  - [Similarity Matrices](#similarity-matrices)
  - [Integration](#integration)
    - [No Integration](#no-integration)
    - [Mean of matrices](#mean-of-matrices)
    - [Similarity Network Fusion](#similarity-network-fusion)
...
- [RESULTS](#results)
  ...
  - [Results](#results-1)
    - [Predictions without Integration](#predictions-without-integration)
    - [Integration via Mean](#integration-via-mean)
    - [Integration via SNF](#integration-via-snf)
    - [Clustering with Spectral Clustering](#clustering-with-spectral-clustering)
    - [Considerations on Silhouette Score](#considerations-on-silhouette-score)
